      ...
      <div className="relative overflow-hidden bg-black">
        <section className="max-w-[1240px]  mb-10 mx-auto grid grid-cols-3 gap-2 font-body h-[930px] overflow-hidden top-7 md:gap-12 medium md:px-1 lg:grid-cols-1 sm:h-full ">
          <div className="relative flex flex-col items-center justify-center h-full min-h-[56vh]  sm:items-center z-50">
            ...
            <div className="absolute  top-[calc(30%+12.5%)] lg:top-[calc(50%+12.5%)] md:top-[calc(80%+12.5%)] sm:top-[calc(115%+12.5%)] left-[15px]  z-50 pt-32">
              {addr ? (
                <button
                  type="button"
          ...
          <div className="flex flex-col items-center relative w-[125%] lg:w-full left-1/2 -translate-x-1/2 z-50 transition-transform duration-500 pt-16">
            <img
              src="/images/Treasure Art_LOGO_L.png"
              className="w-[581px] max-w-full h-auto z-50 md:-mt-80 sm:-mt-80"
